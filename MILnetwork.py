...
trainset=tf.data.TFRecordDataset(filenames=['./EDNs Radiomic features and an Example of TFrecord/MILTrain1.tfrecords'])
...
testset=tf.data.TFRecordDataset(filenames=['./EDNs Radiomic features and an Example of TFrecord/MILTest1.tfrecords'])
